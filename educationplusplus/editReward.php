...
<div id="form" style="width:650px;height:600px;overflow:auto;">
	<div style="width:300px;float:left;">
		...
		<table>
			...
			<tr>
				<td>Expiry Date</td>
				<td><input type="date" value="' . $Incentive->expiryDate->format('Y-m-d') . '" class="required" style="margin-right:10px;width:200px;" id="rewardExpiryDate" name="rewardExpiryDate"><br/><span id="expReq" style="color:red;display:none;">You Must Specify an Expiry Date</span></td>
			</tr>
			<tr>
