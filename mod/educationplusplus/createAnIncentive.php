...
if($isProfessor){
	...
	echo '<div id="introbox" style="width:900px;margin:0 auto;text-align:center;margin-bottom:15px;">
			...
			<p>To reward students, you can create incentives for them to purchase. You can either <a href="createAReward.php?id='. $cm->id .'">create a reward</a>, or <a href="createABadge.php?id='. $cm->id .'">create a badge</a></p>
